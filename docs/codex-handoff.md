...
- **Current status:** The configuration-fingerprint fix is implemented and focused Ruff and Git whitespace checks pass. The full CI suite and deployment remain pending; no August 28 production run was persisted, published, or emailed during this work.
